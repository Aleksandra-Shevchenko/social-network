...
import { getPersonalInfo, getStatus, updateStatus, savePhoto } from '../../redux/profileReducer';
...
export default compose(
  connect(mapStateToProps, {getPersonalInfo, getStatus, updateStatus, savePhoto}),
  withRouter,
  WithAuthRedirect
)(ProfileContainer);